	  ...
	  <table class="table table-striped mb-5">
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td class="align-middle"><?php echo $participant[$i]['status'] ?></td>
	  ...
	  <table class="table table-striped mb-5">
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td class="align-middle">
	        <a href="delete-conf.php?idConf=<?php echo  $homeConf[$i]['id']?>" class="btn btn-danger">Supprimer</a></td>
	      </tr>
	       <?php $i++ ; } ?>
	   </tbody>
	  </table>
